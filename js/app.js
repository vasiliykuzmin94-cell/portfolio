(function () {
  ...
  const UI = IS_EN
    ? {
        ...
        cover: {
          ...
          'serm-ai-23': { value: '5+2', label: 'self-serve users', sub: 'ERID in 1 click' },
    ...
    : {
        ...
        cover: {
          ...
          'serm-ai-23': { value: '5+2', label: 'сами берут ERID', sub: 'в 1 клик' },
  ...
  const TAG_RULES = [
    ...
    { pattern: /\bai\b|generative|ии|нейрос|neuroapi/i, tag: 'AI' },
    { pattern: /\berid\b/i, tag: 'ERID' },
    { pattern: /\bord\b|орд/i, tag: 'ORD' },
    { pattern: /\bocr\b/i, tag: 'OCR' },
    { pattern: /compliance|маркировк|ккту|самореклам/i, tag: 'Compliance' },
    { pattern: /\bmvp\b/i, tag: 'MVP' },
    { pattern: /\bfastapi\b/i, tag: 'FastAPI' },
    { pattern: /лизинг|leasing|\bbaltlease\b|балтлиз/i, tag: IS_EN ? 'Leasing' : 'Лизинг' },
