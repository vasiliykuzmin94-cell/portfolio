  ...
  const UI = IS_EN
    ? {
        ...
        cover: {
          ...
          'serm-ai-22': { value: '9:16', label: 'stories in minutes', sub: 'from lot photo · no designer' },
    ...
    : {
        ...
        cover: {
          ...
          'serm-ai-22': { value: '9:16', label: 'сторис за минуты', sub: 'из фото лота · без дизайнера' },
