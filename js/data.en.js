  ...
  "cases": [
    ...
    },
    {
      ...
      "imageLabels": [
        ...
        "Search ad example 1",
        "Search ad example 2",
        "Website footer setup example",
        "Display banner example 1",
        "Display banner example 2"
      ]
    },
    {
      "id": "performance-2",
      ...
      "imageLabels": [
        "Demographics of people submitting leads",
        "Final stats 1",
        "Final stats 2",
        "Bid adjustments",
        "Search ad example",
    ...
    },
    {
      ...
      "summary": "Built Baltlease a smart used-equipment stock showcase from the live Excel export — while the big catalog was still stuck in development. No photos as a “classifieds board”: positioned as “get it before Avito”, with natural-language search and leads tied to the real folder ID. First outreach brought 40+ leads in two days.",
    ...
    },
    {
      ...
      "summary": "Extended the internal equipment photo-prep tool: from a lot photo, a manager builds a branded 9:16 Baltliz Story in about 15 seconds — no designer. Branches produce Telegram and status creatives themselves and move used equipment into sale faster.",
    ...
    },
    {
      ...
      "summary": "Built an internal AI tool that cleans equipment photos for the site and Avito in 10–15 seconds: removes clutter from the frame, normalizes to 4:3, and adds the logo. An MVP with no department budget or engineering team — the team uses it day to day, without Photoshop.",
      ...
      "imageLabels": [
        "Service UI screenshot: before / after"
      ]
    },
    {
      "id": "serm-ai-23",
      ...
      "summary": "Built Baltliz an internal self-promo labeling service: upload a creative — get an ERID in one click via OCR and Yandex ORD. Five designers and two managers mark up their visuals themselves, without a manual cabinet chain for every file.",
      ...
      "cover": "assets/cases/serm-ai-23/cover-01.webp",
      "images": [
        "assets/cases/serm-ai-23/cover-01.webp"
      ],
      "imageLabels": [
    ...
    },
    {
      ...
      "summary": "Instead of an agency quote above 150,000 ₽, I built 1C-Rarus a test news channel inside 1C: a PHP/XML feed plus impression and click tracking. Enough to see whether the audience actually sees the news — and whether the contour is worth scaling — without external development.",
    ...
    },
    {
      ...
      "imageLabels": [
        "Visit growth",
        "Search rankings for remote courses",
        "Search rankings screenshot"
      ]
    },
    {
      "id": "web-seo-14",
    ...
    },
    {
      ...
      "summary": "Produced viral videos with digital avatars of the CEO and COO — at zero video-production cost. The piece landed in niche Telegram channels and Leasing in Russia media, and the CEO used it as the centerpiece of a keynote at the main industry exhibition.",
